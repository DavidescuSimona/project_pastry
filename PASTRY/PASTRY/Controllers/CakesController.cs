...
namespace PASTRY.Controllers
{
    public class CakesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdImage,Name,Price,Weight")] Cake cake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdImage,Name,Price,Weight")] Cake cake)
        {
            if (id != cake.Id)
            {
                return NotFound();
